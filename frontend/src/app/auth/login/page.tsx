              ...
              >
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 rounded border-slate-300 text-black focus:ring-black/20 focus:ring-offset-0 focus:outline-none transition-colors accent-black cursor-pointer"
                  />
